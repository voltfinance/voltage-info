      ...
      <ContentWrapper>
        <RowBetween>
          <TYPE.body>
            ...
            <Link lineHeight={'145.23%'} href={'https://explorer.fuse.io/address/' + account} target="_blank">
              {' '}
              {account?.slice(0, 42)}{' '}
            </Link>
          </TYPE.body>
        ...
        <Header>
          <RowBetween>
            <span>
              ...
              <Link lineHeight={'145.23%'} href={'https://explorer.fuse.io/address/' + account} target="_blank">
                <TYPE.main fontSize={14}>View on Fuse Explorer</TYPE.main>
              </Link>
            </span>
            <AccountWrapper>
              <StyledIcon>
            ...
            <DropdownWrapper>
              ...
              {showDropdown && (
                <Flyout>
                  <AutoColumn gap="0px">
                    {positions?.map((p, i) => {
                      if (p.pair.token1.symbol === 'WFUSE') {
                        p.pair.token1.symbol = 'FUSE'
                      }
                      if (p.pair.token0.symbol === 'WFUSE') {
                        p.pair.token0.symbol = 'FUSE'
                      }
                      return (
