  ...
  useEffect(() => {
    async function fetch() {
      healthClient
        ...
        .then((res) => {
          const syncedBlock = res.data[0]?.indexingStatusForCurrentVersion.chains[0].latestBlock.number
          const headBlock = res.data[0]?.indexingStatusForCurrentVersion.chains[0].chainHeadBlock.number
